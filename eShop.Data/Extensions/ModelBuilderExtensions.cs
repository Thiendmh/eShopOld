    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            //Identity seed
            var roleId = new Guid("0EB639A2-ECF9-4273-817D-33A208601268");
            var adminId = new Guid("C53F0FE1-29D1-49FB-8B09-5C25CEB4FCFE");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "dinhducthien@gmail.com",
                NormalizedEmail = "dinhducthien@gmail.com",
                EmailConfirmed = true,
                PasswordHash = new PasswordHasher<AppUser>().HashPassword(null, "abcde12345-"),
                SecurityStamp = string.Empty,
                FirstName = "Thien",
                LastName = "Dinh",
                Dob = new DateTime(2020, 10, 10)
            });
